...
export default function Navbar() {
  ...
  return (
    <nav className="w-full min-h-[80px] max-w-[1920px] mx-auto z-50 fixed top-0 left-0 right-0 flex flex-row justify-between items-center bg-neutral-800/40 px-8 font-[Poppins] text-zinc-50 text-base shadow-sm shadow-neutral-200/20 backdrop-blur-md">

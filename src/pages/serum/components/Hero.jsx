...
export default function Hero() {
  ...
  return (
    <div ref={heroRef} className="w-full max-w-[1920px] h-screen max-h-[1080px] relative">
      <HeroCanvas />
      <div className="absolute top-0 left-0 w-full h-full flex flex-row justify-center items-center bg-neutral-950/50 backdrop-blur-sm">
        <div className="w-[80%] sm:w-[400px] lg:w-[900px] lg:aspect-[16/9] flex flex-col lg:flex-row justify-center items-center p-10 lg:p-6 gap-6 lg:gap-12">
          <div className="hero-img card-wrapper w-[250px] sm:w-[280px] lg:w-[370px] max-w-[400px] aspect-square overflow-hidden flex justify-center items-center">
            <div className="card-content flex flex-row items-center justify-center overflow-hidden">
              ...
              <img
                src="/serum-2.jpg"
                alt="serum synth"
                className="max-w-fit w-full h-full object-cover"
              />
            </div>
          </div>

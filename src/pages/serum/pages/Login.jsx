    ...
    <div className="w-full max-w-[1920px] h-screen relative">
      ...
      <div className="absolute top-0 left-0 w-full min-h-screen flex flex-row justify-center items-center">
        <form
          ...
          action=""
          className="w-full 3cols:w-[500px] min-h-[calc(500px*2.25/2)] p-8 bg-neutral-900/20 rounded-xl flex flex-col items-center gap-y-6 shadow-sm shadow-neutral-100/50"
        >
